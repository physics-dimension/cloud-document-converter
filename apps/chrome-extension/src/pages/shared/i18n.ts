...
export const i18n = createI18n({
  ...
  messages: {
    'en-US': {
      ...
      'lark.docx.batch_download': 'Download descendants as Markdown',
      'help.and.feedback': 'Help and Feedback',
      'batch.download.title': 'Batch Download',
      'batch.download.progress': 'Progress',
      'batch.download.status': 'Status',
      'batch.download.current': 'Current Page',
      'batch.download.failures': 'Failures',
      'batch.download.cancel': 'Cancel',
      'batch.download.retry': 'Reload',
      'batch.download.logs': 'Task Log',
      'batch.download.logs.empty': 'Preparing the batch task...',
    },
    'zh-CN': {
      general: '通用',
      save: '保存',
      ...
      'lark.docx.batch_download': '递归下载为 Markdown',
      'help.and.feedback': '帮助和反馈',
      'batch.download.title': '批量下载',
      'batch.download.progress': '进度',
      'batch.download.status': '状态',
      'batch.download.current': '当前页面',
      'batch.download.failures': '失败数量',
      'batch.download.cancel': '取消',
      'batch.download.retry': '重新加载',
      'batch.download.logs': '任务日志',
      'batch.download.logs.empty': '正在准备批量任务……',
    },
  },
})
